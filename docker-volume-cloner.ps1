...
# This is a windows powershell script that can help to easily create a clone of a 
# given data volume. The script can be very useful if you are using named volumes.
